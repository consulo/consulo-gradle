...
import consulo.gradle.tooling.buildler.util.ReflectionMethod;
...
public class ModuleExtendedModelBuilderImpl implements ModelBuilderService
{
	...
	private static final ReflectionMethod<File, SourceSetOutput> SourceSetOutput__getClassesDir = new ReflectionMethod<>(SourceSetOutput.class, "getClassesDir");
	private static final ReflectionMethod<Iterable<File>, SourceSetOutput> SourceSetOutput__getClassesDirs = new ReflectionMethod<>(SourceSetOutput.class, "getClassesDirs");
	...
	private static void enrichDataFromIdeaPlugin(Project project, Set<File> excludeDirectories, Set<String> javaDirectories, Set<String> testDirectories)
	{
