...
public class WarDirectory implements Serializable
{
	...
	private static final WarDirectory[] WAR_DIRECTORIES = new WarDirectory[]{
			WAR_ROOT,
			META_INF,
			WEB_INF,
			WEB_INF_LIB,
	...
	public boolean isCustomDirectory()
	{
		...
		{
			if(myRelativePath.equals(warDirectory.getRelativePath()))
			{
				return false;
			}
		}
	...
	public static WarDirectory fromPath(final @Nonnull String path)
	{
		...
		for(WarDirectory warDirectory : WAR_DIRECTORIES)
		{
			if(warDirectory.myRelativePath.equals(adjustedPath))
			{
				return warDirectory;
			}
		}
	...
	public boolean equals(Object o)
	{
		...
		if(!myRelativePath.equals(directory.myRelativePath))
		{
			return false;
		}
		return true;
