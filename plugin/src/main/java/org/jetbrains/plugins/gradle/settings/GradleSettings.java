...
public class GradleSettings extends AbstractExternalSystemSettings<GradleSettings, GradleProjectSettings,
    ...
    private boolean myEnableCompilerOverride;
    ...
    public static GradleSettings getInstance(@Nonnull Project project) {
        return project.getInstance(GradleSettings.class);
    }
    ...
    protected void copyExtraSettingsFrom(@Nonnull GradleSettings settings) {
        ...
        myEnableCompilerOverride = settings.isOfflineWork();
    }
    ...
    public GradleSettings.MyState getState() {
        ...
        state.enableCompilerOverride = myEnableCompilerOverride;
        return state;
    }
    ...
    public void loadState(MyState state) {
        ...
        myEnableCompilerOverride = state.enableCompilerOverride;
    }
    ...
    public boolean isEnableCompilerOverride() {
        return myEnableCompilerOverride;
    }

    public void setEnableCompilerOverride(boolean enableCompilerOverride) {
        myEnableCompilerOverride = enableCompilerOverride;
    }
    ...
    public static class MyState implements State<GradleProjectSettings> {
        ...
        public boolean enableCompilerOverride;
