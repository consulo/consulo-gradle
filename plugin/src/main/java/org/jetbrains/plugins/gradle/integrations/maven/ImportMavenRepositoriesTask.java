...
public class ImportMavenRepositoriesTask implements Runnable
{
	...
	public void run()
	{
		...
		{
			final String externalSystemId = ExternalSystemApiUtil.getExtensionSystemOption(module, ExternalSystemConstants.EXTERNAL_SYSTEM_ID_KEY);
		...
		{
			Set<MavenRemoteRepository> remoteRepositories = ContainerUtil.newHashSet();
